...
{
    // ipad适应
    CGRect selfFrame = CGRectMake(0, 0, 320, 480);
//    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
//        selfFrame = CGRectMake(0, 0, 1024, 768);
//    }
    ...
    if (self = [super initWithFrame:selfFrame])
    {
        ...
        // add the panel view
        CGRect panelViewFrame = CGRectMake(10, 30, 300, 440);
//        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
//            panelViewFrame = CGRectMake(512, 0, 300, 300);
//        }        
        panelView = [[UIView alloc] initWithFrame:panelViewFrame];
        ...
        CGRect containerViewFrame = CGRectMake(10, 10, 280, 420);
//        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
//            containerViewFrame = CGRectMake(20, 20, 560, 840);
//        }   
		...
		[closeButton setFrame:CGRectMake(460 - 19 - 10, 10, 19, 19)];
...
//        [indicatorView setCenter:CGPointMake(240, 160)];
        ...
        [panelView setFrame:CGRectMake(512 - 460 / 2, 384 - 520 / 2, 460, 520)];
        [containerView setFrame:CGRectMake(10, 10, 440, 500)];
        [webView setFrame:CGRectMake(0, 0, 440, 500)];
